;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="4e6ca70f-02dc-b2f4-0083-7b5456fc7388")}catch(e){}}();
(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,127384,e=>{"use strict";e.s(["APP_HEADER_HEIGHT",0,40,"COLLAPSED_TASK_SIDEBAR_WIDTH",0,44,"HEADER_HEIGHT",0,48,"HEADER_Z_INDEX",0,1002,"SIDEBAR_OVERLAY_Z_INDEX",0,1e3,"SIDEBAR_WIDTH",0,240,"SIDEBAR_Z_INDEX",0,1001])},201894,e=>{"use strict";var r=e.i(276385),t=e.i(711223),n=e.i(967629),o=e.i(480028),i=e.i(462229),l=e.i(9620),a=e.i(691636),s=e.i(244945),u=e.i(61732);let p=(0,n.keyframes)("from{opacity:0}to{opacity:1}"),d=(0,i.cssRecord)({self:[a.rcss.flex.row,a.rcss.flex.growAndShrink(1),a.rcss.height(o.tokens.space12),a.rcss.borderRadius(4),a.rcss.position.relative,a.rcss.overflow("clip")],progressWrapper:[a.rcss.height("100%"),a.rcss.width("100%"),a.rcss.borderRadius(4),a.rcss.position.relative],progress:[a.rcss.position.relative,a.rcss.width("100%"),a.rcss.height("100%"),{top:0,left:0}],loading:l.loadingStyle.backgroundPulse(),fadeInAnim:{animation:`${p} 120ms forwards ease-out alternate`}});function c({current:e,total:t,color:n=o.tokens.accentPrimaryDefault,disabled:i=!1,minWidthPercent:l=0}){let a=Math.max(function(e=0,r=0){return 0===r||0===e?0:Math.max(0,Math.min(100,e/r*100))}(e,t),l),s={backgroundColor:i?o.tokens.outlineDefault:n,width:a+"%"};return(0,r.jsx)(u.View,{css:d.progress,style:s,role:"meter",className:"measureBarProgress","aria-label":`${e} out of ${t}`,"aria-valuemin":0,"aria-valuenow":e,"aria-valuemax":t})}e.s(["MeasureBar",0,function({total:e,tooltip:n,className:o,disabled:i=!1,loading:l=!1,tooltipHidden:a=!1,...p}){let g=null;return n?g=n:"current"in p?g=`${p.current||"0"}/${e}`:"data"in p&&(g=p.data?.map(({current:r})=>`${r||"0"}/${e}`).join(" | ")),(0,r.jsx)(s.Tooltip,{placement:"top",tooltip:g,maxWidth:280,isDisabled:l||a,children:(n,a)=>{let s;return l?s=null:"current"in p&&p.current?s=(0,r.jsx)(c,{total:e,disabled:i,current:p.current,color:p.color,minWidthPercent:p.minWidthPercent}):"data"in p&&(s=p.data?.map((r,n)=>(0,t.createElement)(c,{...r,key:`measure-bar-${n}`,total:e,disabled:i,minWidthPercent:p.minWidthPercent}))),(0,t.createElement)(u.View,{...n,css:[d.self,d.fadeInAnim,l&&d.loading],className:o,innerRef:a,onClick:void 0,key:l?"loadingMeasureBar":"finishedLoadingMeasureBar",role:"group"},(0,r.jsx)(u.View,{css:d.progressWrapper,grow:!0,shrink:!0,row:!0,style:p.backgroundColor?{backgroundColor:p.backgroundColor}:{},children:s},"measureBarProgress"))}})}])},970410,e=>{"use strict";var r=e.i(973245),t=e.i(444008);let n=r.gql`
  ...
  name
    ...
    `;t.OrgCurrentUserFragmentDoc,t.OrgMetadataFragmentDoc,e.s(["OrgGroupMetadataFragmentDoc",0,n])},130902,e=>{"use strict";var r=e.i(973245),t=e.i(444008),n=e.i(304277);e.i(566901);let o={},i=r.gql`
  ...
  currentUser {
    ...
    ${l}`;e.s(["OrgGroupsOrgFragmentDoc",0,a,"OrgGroupsOrgGroupFragmentDoc",0,i,"useOrgGroupsQuery",0,function(e){let r={...o,...e};return n.useQuery(s,r)}])},667746,e=>{"use strict";var r=e.i(973245),t=e.i(970410),n=e.i(319801),o=e.i(951262),i=e.i(304277),l=e.i(566901);let a={},s=r.gql`
...
${s}`,p=r.gql`
  ...
  currentUser {
    ...
    ${f}`;e.s(["OrgGroupPermissionsGroupFragmentDoc",0,u,"useOrgGroupPermissionsGroupsQuery",0,function(e){let r={...a,...e};return i.useQuery(_,r)},"useOrgGroupPermissionsReplsQuery",0,function(e){let r={...a,...e};return i.useQuery(y,r)},"useOrgGroupReplScopeOptionsLazyQuery",0,function(e){let r={...a,...e};return l.useLazyQuery(x,r)},"useOrgGroupReplScopeOptionsQuery",0,function(e){let r={...a,...e};return i.useQuery(x,r)},"useOrgGroupScopeOptionsQuery",0,function(e){let r={...a,...e};return i.useQuery(C,r)},"useUpdateOrgGroupScopesMutation",0,function(e){let r={...a,...e};return o.useMutation(R,r)}])},820669,e=>{"use strict";var r=e.i(973245);let t=r.gql`
  ...
  subscriptionSummary {
    ...
    `;e.s(["CollaboratorCountV2CustomerFragmentDoc",0,t])},99357,e=>{"use strict";var r=e.i(973245),t=e.i(667746),n=e.i(444008),o=e.i(820669),i=e.i(130902);e.i(304277),e.i(566901);var l=e.i(951262);let a={},s=r.gql`
...
${d}`,g=r.gql`
  ...
  grantReplAccessByEmail(input: $input) {
    ...
    ${c}`;e.s(["ReplMultiplayerStatusV2FragmentDoc",0,c,"useGrantReplAccessByEmailMutation",0,function(e){let r={...a,...e};return l.useMutation(m,r)},"useUpdateOrgGroupScopesV2Mutation",0,function(e){let r={...a,...e};return l.useMutation(g,r)}])},669011,e=>{"use strict";var r=e.i(973245),t=e.i(99357),n=e.i(304277);e.i(566901);let o={},i=r.gql`
  ...
  getRepl(id: $replId) {
    ...
    ${t.ReplMultiplayerStatusV2FragmentDoc}`;e.s(["ReplEnvironmentHeaderInviteButtonReplFragmentDoc",0,i,"useInviteButtonOrgReplPermsQuery",0,function(e){let r={...o,...e};return n.useQuery(l,r)}])},117714,e=>{"use strict";var r=e.i(973245),t=e.i(304277);e.i(566901);let n={},o=r.gql`
  ...
  getRepl(id: $replId) {
    ...
    `;e.s(["NewPaneReplFragmentDoc",0,o,"useNewPanePrimaryOutputQuery",0,function(e){let r={...n,...e};return t.useQuery(i,r)}])},949791,e=>{"use strict";var r=e.i(973245);let t=r.gql`
    fragment AiProviderCurrentUser on CurrentUser {
  id
  timeCreated
}
    `;e.s(["AiProviderCurrentUserFragmentDoc",0,t])},764992,e=>{"use strict";var r=e.i(973245);let t=r.gql`
  ...
  authorizations {
    ...
    `;e.s(["CrosisContextCurrentUserFragmentDoc",0,t,"CrosisContextReplFragmentDoc",0,n])},575872,29530,663197,e=>{"use strict";var r=e.i(973245),t=e.i(304277);e.i(566901);var n=e.i(951262);let o={},i=r.gql`
...
${i}`,s=r.gql`
  ...
  project {
    ...
    `;e.s(["ReplInfoReplFragmentDoc",0,c],663197)},838317,e=>{"use strict";var r=e.i(973245),t=e.i(180273),n=e.i(669011),o=e.i(762288),i=e.i(85085),l=e.i(304277);e.i(566901);let a={},s=r.gql`
...
${i.OrgSwitcherCurrentUserFragmentDoc}`,p=r.gql`
  ...
  currentUser {
    ...
    ${s}
${u}`;e.s(["WorkspaceHeaderNavMenuReplFragmentDoc",0,s,"useWorkspaceHeaderNavMenuQuery",0,function(e){let r={...a,...e};return l.useQuery(p,r)}])},966824,e=>{e.v({defaultText:"RecentReplsMenu-module__Zg4UXW__defaultText",recentReplsLabel:"RecentReplsMenu-module__Zg4UXW__recentReplsLabel",surfaceShades:"RecentReplsMenu-module__Zg4UXW__surfaceShades"})},345836,72159,689736,913864,280729,e=>{"use strict";var r=e.i(276385),t=e.i(389959),n=e.i(486597),o=e.i(624071),i=e.i(32988),l=e.i(973245),a=e.i(764992),s=e.i(575872),u=e.i(949791),p=e.i(180273),d=e.i(74768),c=e.i(29530),g=e.i(663197),m=e.i(669011),f=e.i(838317);let R=l.gql`
    fragment DesktopAppNavMenuRepl on Repl {
  ...WorkspaceHeaderNavMenuRepl
}
    ${f.WorkspaceHeaderNavMenuReplFragmentDoc}`,_=l.gql`
  ...
  ...DesktopAppNavMenuRepl
    ...
    ${g.ReplInfoReplFragmentDoc}
${m.ReplEnvironmentHeaderInviteButtonReplFragmentDoc}
${R}`;var C=e.i(117714),y=e.i(304277);e.i(566901);var x=e.i(951262);let h={},v=l.gql`
  ...
  getFigmaIntermediateToken(input: $input) {
    ...
    `;e.s(["FigmaImportFlowReplFragmentDoc",0,v,"useFigmaImportFlowQuery",0,function(e){let r={...h,...e};return y.useQuery(w,r)},"useGetFigmaIntermediateTokenMutation",0,function(e){let r={...h,...e};return x.useMutation(S,r)},"useUpdateReplForFigmaImportMutation",0,function(e){let r={...h,...e};return x.useMutation(I,r)}],72159);let U=l.gql`
  ...
  authorizations {
    ...
    `;var O=e.i(319801);let b={},k=l.gql`
  ...
  org {
    ...
    ${O.ReplLinkReplFragmentDoc}`,G=l.gql`
  ...
  getRepl(id: $replId) {
    ...
    ${E}
${k}
${F}`;e.s(["HandleReplRedirectionReplFragmentDoc",0,E,"HandleReplRedirectionReplRedirectFragmentDoc",0,k,"HandleReplRedirectionSubscriptionExpiredFragmentDoc",0,F,"useHandleReplRedirectionQuery",0,function(e){let r={...b,...e};return y.useQuery(G,r)}],689736);let $=l.gql`
  ...
  ...IsUnifiedPlanEnabledPersonalWorkspaceCurrentUser
    ...
    ${a.CrosisContextCurrentUserFragmentDoc}
${s.WorkspaceDoGitProviderImportCurrentUserFragmentDoc}
${u.AiProviderCurrentUserFragmentDoc}
${p.IsUnifiedPlanEnabledPersonalWorkspaceCurrentUserFragmentDoc}`,P=l.gql`
...
${a.CrosisContextReplFragmentDoc}
...
${v}
${U}
${E}`;e.s(["ReplAiAuthorizationsFragmentDoc",0,P,"ReplEnvironmentDesktopCurrentUserFragmentDoc",0,$,"ReplEnvironmentDesktopReplFragmentDoc",0,D],913864);let j={},M=l.gql`
  ...
  allRecentRepls: recentRepls(count: $count) {
    ...
    ${M}`;function A(e){let r={...j,...e};return y.useQuery(T,r)}let q=l.gql`
  ...
  currentUser {
    ...
    ${M}`;function L(e){let r={...j,...e};return y.useQuery(q,r)}e.s(["useSidebarRecentOrgReplsQuery",0,L,"useSidebarRecentReplsQuery",0,A],280729);var B=e.i(269848),V=e.i(761201),W=e.i(780902),H=e.i(127384),N=e.i(919073),Q=e.i(295231),z=e.i(798142),X=e.i(8047),Z=e.i(61732),Y=e.i(921125),K=e.i(365757),J=e.i(966824);let ee=({repl:e})=>{let t=(0,Y.replLinkProps)(e);return(0,r.jsx)(Q.MenuItem,{icon:(0,r.jsx)(K.default,{size:16,iconUrl:e.iconUrl,alt:e.title}),label:e.title,href:t.href,as:t.as})},er=({loading:e,recentRepls:t})=>{let n=V.REPL_DISPLAY_NAME.plural,o=e&&!t?.length?(0,r.jsx)(Z.View,{grow:!0,justify:"center",align:"center",children:(0,r.jsx)(B.default,{})}):(0,r.jsx)(r.Fragment,{children:t?.length?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(X.Text,{multiline:!1,variant:"small",color:"dimmer",clsx:J.default.recentReplsLabel,children:["Recent ",n]}),(0,r.jsx)(Q.Menu,{"aria-label":`Recent ${n}`,children:t.map(e=>(0,r.jsx)(ee,{repl:e},e.id))})]}):(0,r.jsx)(Z.View,{grow:!0,justify:"center",align:"center",children:(0,r.jsxs)(X.Text,{variant:"small",color:"dimmer",clsx:J.default.defaultText,children:["Recently viewed ",n," will show up here"]})})});return(0,r.jsx)(N.ShadesSurface,{colorShade:"themePopup",p:4,br:6,border:"regular",clsx:J.default.surfaceShades,children:o})},et=(e,r)=>{if(!r)return!1;let{clientX:t,clientY:n}=e,{left:o,right:i,top:l,bottom:a}=r.getBoundingClientRect();return t>=o&&t<=i&&n>=l&&n<=a};e.s(["OrgSidebarRecentRepls",0,({orgId:e})=>{let{data:t,loading:n}=L({variables:{count:6,orgId:e},ssr:!1,fetchPolicy:"cache-and-network",nextFetchPolicy:"cache-first"}),o=t?.currentUser?.org?.__typename==="Org"?t?.currentUser?.org?.recentRepls.items:void 0;return(0,r.jsx)(er,{loading:n,recentRepls:o})},"RECENT_REPLS_SIDEBAR_MENU_COUNT",0,6,"RecentReplsPopover",0,({children:e})=>{let{setTriggerElement:l,setPopoverElement:a,styles:s,attributes:u,triggerElement:p,popoverElement:d}=(()=>{let[e,r]=(0,t.useState)(null),[n,o]=(0,t.useState)(null),{styles:l,attributes:a}=(0,i.usePopper)(e,n,{modifiers:[{name:"offset",options:{offset:[0,4]}}],placement:"right-start"});return{setTriggerElement:r,setPopoverElement:o,styles:l.popper,attributes:a.popper,triggerElement:e,popoverElement:n}})(),c=(0,n.useOverlayTriggerState)({}),g=(({setOpen:e,timeout:r=200,triggerElement:n,popoverElement:o})=>{let i=(0,t.useRef)(null),l=(0,t.useRef)(!0);return(0,t.useEffect)(()=>{let e=e=>{n&&(l.current=!et(e,n)),r()},r=()=>{document.body.removeEventListener("mouseenter",e)};return document.body.addEventListener("mouseenter",e),r},[n]),{onMouseMove:(0,t.useCallback)(()=>{l.current&&(e(!0),i.current&&clearTimeout(i.current))},[e]),onMouseLeave:(0,t.useCallback)(t=>{i.current&&clearTimeout(i.current),l.current=!0,et(t,o)||(i.current=setTimeout(()=>{e(!1)},r))},[e,r,o])}})({setOpen:c.setOpen,popoverElement:d,triggerElement:p}),[m,f]=e,R=(0,W.useIsMobile)();return(0,r.jsxs)(r.Fragment,{children:[m(g,l),c.isOpen&&!R&&(0,r.jsx)(z.Portal,{children:(0,r.jsx)("div",{"aria-hidden":!0,ref:a,style:{...s,zIndex:H.SIDEBAR_Z_INDEX},...(0,o.mergeProps)(u,g),children:f})})]})},"SidebarRecentRepls",0,()=>{let{data:e,loading:t}=A({variables:{count:6},ssr:!1,fetchPolicy:"cache-and-network",nextFetchPolicy:"cache-first"});return(0,r.jsx)(er,{loading:t,recentRepls:e?.allRecentRepls})}],345836)},180273,e=>{"use strict";var r=e.i(973245);let t=r.gql`
  ...
  isUnifiedPlanEnabledForAnyOrg
    ...
    `;e.s(["IsUnifiedPlanEnabledForAnyOrgFragmentDoc",0,o,"IsUnifiedPlanEnabledOrgFragmentDoc",0,t,"IsUnifiedPlanEnabledPersonalWorkspaceCurrentUserFragmentDoc",0,n])},856010,e=>{"use strict";var r=e.i(730497);e.s(["useIsUnifiedPlanEnabled",0,function(e){let t=(0,r.useFlag)({controlName:"feat-unified-plans-killswitch"}),n=(0,r.useFlag)({controlName:"feat-unified-plans-bypass"});return!t&&(!!n||(e.org?e.org.customer?.__typename==="Customer"&&e.org.customer.isUnifiedPlanEnabled:!!e.currentUser&&e.currentUser.customer.isUnifiedPlanEnabled))},"useIsUnifiedPlanEnabledForAnyOrg",0,function(e){let t=(0,r.useFlag)({controlName:"feat-unified-plans-killswitch"}),n=(0,r.useFlag)({controlName:"feat-unified-plans-bypass"});return!t&&(!!n||!!e&&e.isUnifiedPlanEnabledForAnyOrg)}])},227430,e=>{e.v({referralBodyTextIcon:"ReferralSocialShare-module__YFBjuW__referralBodyTextIcon",referralSocialRow:"ReferralSocialShare-module__YFBjuW__referralSocialRow",referralSocialText:"ReferralSocialShare-module__YFBjuW__referralSocialText"})},908174,341515,e=>{"use strict";var r=e.i(276385),t=e.i(936706),n=e.i(765826);let o="https://twitter.com/intent/tweet";function i({text:e,url:r,hashtags:t,via:n}={}){let l=new URLSearchParams;e&&l.append("text",e),r&&l.append("url",r),t&&l.append("hashtags",t.join(",")),n&&l.append("via",n);let a=l.toString();return a.length>0?`${o}?${a}`:o}e.s(["default",0,i],341515);var l=e.i(8047),a=e.i(61732),s=e.i(227430);let u=`Join me on Replit! Get $${n.REFERRAL_CREDIT_AMOUNT_USD} in credits when you subscribe to a paid plan.`;e.s(["ReferralSocialShare",0,function({referralLink:e}){let n=i({text:u,url:e});return(0,r.jsxs)(a.View,{clsx:s.default.referralSocialRow,children:[(0,r.jsx)(l.Text,{color:"dimmer",clsx:s.default.referralSocialText,children:"Share on Socials"}),(0,r.jsx)("a",{href:n,target:"_blank",rel:"noopener noreferrer",className:s.default.referralSocialIcon,"aria-label":"Share on X",children:(0,r.jsx)(a.View,{row:!0,align:"center",gap:8,clsx:s.default.referralBodyTextIcon,children:(0,r.jsx)(t.default,{size:10})})})]})}],908174)},663602,e=>{e.v({copyButtonWrap:"ReferralUrl-module__gpHkyG__copyButtonWrap",root:"ReferralUrl-module__gpHkyG__root",urlDisplay:"ReferralUrl-module__gpHkyG__urlDisplay",urlRow:"ReferralUrl-module__gpHkyG__urlRow"})},799119,e=>{"use strict";var r=e.i(276385),t=e.i(580519),n=e.i(8047),o=e.i(61732),i=e.i(663602);e.s(["ReferralUrl",0,function({url:e,onCopy:l}){return(0,r.jsxs)(o.View,{row:!0,align:"center",clsx:i.default.root,children:[(0,r.jsx)(o.View,{row:!0,align:"stretch",clsx:i.default.urlRow,children:(0,r.jsx)(n.Text,{color:"dimmer",clsx:i.default.urlDisplay,children:e})}),(0,r.jsx)(o.View,{clsx:i.default.copyButtonWrap,children:(0,r.jsx)(t.CopyButton,{clsx:i.default.copyButton,textToCopy:e,tooltipText:"Copy referral link",text:"Copy link",colorway:"primary",showIcon:!0,onCopy:l})})]})}])},328867,e=>{e.v({linkCopyRow:"ReferralLinkField-module__gXlPVG__linkCopyRow"})},557590,e=>{"use strict";var r=e.i(276385),t=e.i(415541),n=e.i(709485),o=e.i(61732),i=e.i(799119),l=e.i(328867);e.s(["ReferralLinkField",0,function({referralLink:e,trackingContext:a,isSubscribed:s}){return(0,r.jsx)(o.View,{children:(0,r.jsx)(o.View,{row:!0,align:"stretch",shrink:!0,clsx:l.default.linkCopyRow,children:(0,r.jsx)(i.ReferralUrl,{url:e,onCopy:()=>{(0,t.track)(n.events.REFERRAL_PROGRAM_USED,{action:"copied_referral_link",trackingContext:a,isSubscribed:s})}})})})}])},709822,e=>{e.v({icon:"LearnMore-module__DxtA0q__icon",link:"LearnMore-module__DxtA0q__link"})},143295,e=>{"use strict";var r=e.i(276385),t=e.i(157630),n=e.i(252204),o=e.i(709822);e.s(["LearnMore",0,function({href:e="https://replit.com/refer",children:i="Learn more"}){return(0,r.jsxs)(t.default,{className:o.default.link,target:"_blank",rel:"noopener noreferrer",href:e,children:[i,(0,r.jsx)(n.default,{clsx:o.default.icon})]})}])},758197,e=>{"use strict";var r=e.i(973245),t=e.i(304277);e.i(566901);let n={},o=r.gql`
