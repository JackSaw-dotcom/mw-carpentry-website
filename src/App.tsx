...
export default function App() {
  ...
  const sty = {
    ...
    hero: { marginTop: 64, height: "85vh", minHeight: 600, background: "linear-gradient(135deg, rgba(12,24,33,0.72) 0%, rgba(12,24,33,0.45) 100%), url('https://www.ete-ltd.co.uk/wp-content/uploads/2019/07Untitled-1_web.jpg') center center / cover no-repeat", display: "flex", alignItems: "center", padding: "0 48px" },
